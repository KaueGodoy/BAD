...
public class NPC_Kaue extends Sprite {
	...
	// animation
	private Animation<TextureRegion> kaueIdle, kaueRight, kaueLeft;
	...
	public NPC_Kaue(Animation<TextureRegion> kaueIdle, Animation<TextureRegion> kaueRight, Animation<TextureRegion> kaueLeft, TiledMapTileLayer collisionLayer) {
		super(kaueIdle.getKeyFrame(0));
		this.kaueIdle = kaueIdle;
		this.kaueRight = kaueRight;
		this.kaueLeft = kaueLeft;
...
//----------------------------------- MOVEMENT -------------------------------------
	...
	public void isIdle() {
		setRegion(kaueIdle.getKeyFrame(animationTime));
		velocity.x = 0;
	}
	
	public void isRight() {
		setRegion(kaueRight.getKeyFrame(animationTime));
		velocity.x = speed;
	}
	
	public void isLeft() {
		setRegion(kaueLeft.getKeyFrame(animationTime));
		velocity.x = -speed;
	}
