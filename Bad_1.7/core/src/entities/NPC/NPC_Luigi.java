...
public class NPC_Luigi extends Sprite {
	...
	// animation
	private Animation<TextureRegion> luigiIdle, luigiRight, luigiLeft;
	...
	public NPC_Luigi(Animation<TextureRegion> luigiIdle, Animation<TextureRegion> luigiRight, Animation<TextureRegion> luigiLeft, TiledMapTileLayer collisionLayer) {
		super(luigiIdle.getKeyFrame(0));
		this.luigiIdle = luigiIdle;
		this.luigiRight = luigiRight;
		this.luigiLeft = luigiLeft;
...
//----------------------------------- MOVEMENT -------------------------------------
	...
	public void isIdle() {
		setRegion(luigiIdle.getKeyFrame(animationTime));
		velocity.x = 0;
	}
	
	public void isRight() {
		setRegion(luigiRight.getKeyFrame(animationTime));
		velocity.x = speed;
	}
	
	public void isLeft() {
		setRegion(luigiLeft.getKeyFrame(animationTime));
		velocity.x = -speed;
	}
