...
public class NPC_Nicolas extends Sprite {
	...
	// animation
	private Animation<TextureRegion> nicolasIdle, nicolasRight, nicolasLeft;
	...
	public NPC_Nicolas(Animation<TextureRegion> nicolasIdle, Animation<TextureRegion> nicolasRight, Animation<TextureRegion> nicolasLeft, TiledMapTileLayer collisionLayer) {
		super(nicolasIdle.getKeyFrame(0));
		this.nicolasIdle = nicolasIdle;
		this.nicolasRight = nicolasRight;
		this.nicolasLeft = nicolasLeft;
...
//----------------------------------- MOVEMENT -------------------------------------
	...
	public void isIdle() {
		setRegion(nicolasIdle.getKeyFrame(animationTime));
		velocity.x = 0;
	}
	
	public void isRight() {
		setRegion(nicolasRight.getKeyFrame(animationTime));
		velocity.x = speed;
	}
	
	public void isLeft() {
		setRegion(nicolasLeft.getKeyFrame(animationTime));
		velocity.x = -speed;
	}
